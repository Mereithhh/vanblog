...
module.exports = {
  ...
  projects: [
    ...
    {
      name: 'bytemd-fixture',
      testMatch: /mermaid-editor\.spec\.js|toc-heading\.spec\.js|toc-drawer\.spec\.js|footnote-nav\.spec\.js|markdown-link\.spec\.js|code-block-lines\.spec\.js|social-card\.spec\.js|page-nav-edges\.spec\.js|nav-site-name\.spec\.js/,
      use: {
        ...devices['Desktop Chrome'],
