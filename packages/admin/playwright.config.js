...
const categoryRenamePort = Number(process.env.CATEGORY_RENAME_E2E_PORT || 4182);
...
module.exports = {
  ...
  webServer: [
    ...
    {
      command: 'node tests/e2e/category-rename-server.mjs',
      url: `http://127.0.0.1:${categoryRenamePort}`,
      reuseExistingServer: !process.env.CI,
      timeout: 30_000,
    },
  ],
  projects: [
    {
      name: 'admin-app',
      testMatch: /admin-editor-.*\.spec\.js|admin-login-expired\.spec\.js|admin-import-pathname\.spec\.js|custom-page-info\.spec\.js|custom-page-upload\.spec\.js|admin-log-audit\.spec\.js|admin-cache-headers\.spec\.js/,
      use: {
    ...
    {
      name: 'bytemd-fixture',
      testMatch: /mermaid-editor\.spec\.js|toc-heading\.spec\.js|toc-drawer\.spec\.js|footnote-nav\.spec\.js|markdown-link\.spec\.js|code-block-lines\.spec\.js|social-card\.spec\.js|page-nav-edges\.spec\.js/,
      use: {
        ...devices['Desktop Chrome'],
    ...
    },
    {
      ...
      testMatch: /category-rename\.spec\.js/,
      use: {
        ...devices['Desktop Chrome'],
        baseURL: `http://127.0.0.1:${categoryRenamePort}`,
        viewport: { width: 1280, height: 800 },
      },
    },
  ],
