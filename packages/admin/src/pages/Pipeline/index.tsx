...
export default function () {
  ...
  const columns = [
    ...
    },
    {
      ...
      title: '状态',
      width: 60,
      render: (enabled: boolean) => (<Tag children={enabled ? "启用" : "禁用"} color={enabled ? "green" : "gray"} />)
    },
    {
      title: '操作',
      width: 180,
      render: (_, record, action) => {
        return (<>
          <Space>
            ...
            <PipelineModal mode="edit" trigger={<a>修改信息</a>} initialValues={record} onFinish={() => {
  ...
  >
    <ProTable
      ...
      columns={columns} search={false} rowKey="id" request={async () => {
